...
public class OrdemVendaController {
    ...
    public int cadastra(@RequestBody FormularioOrdemVenda formulario) {
        var ordemVenda = ordemVendaService.cadastra(formulario.idCliente(), formulario.dataEntrega(), formulario.logradouro(), formulario.numero(), formulario.bairro(), formulario.estado(), formulario.cep(), formulario.informacoesAdicionais(), formulario.status(), formulario.detalhes());
    ...
    public void atualiza(@PathVariable int id, @RequestBody FormularioOrdemVenda formulario) {
        ordemVendaService.atualiza(id, formulario.dataEntrega(), formulario.logradouro(), formulario.numero(), formulario.bairro(), formulario.estado(), formulario.cep(),  formulario.informacoesAdicionais(), formulario.status(), formulario.detalhes());
    }
